...
const App = () => {
    const [step, setStep] = useState('landing'); // landing, quiz, loading, result, admin
    ...
    // Proctoring logic: Track tab switches
    useEffect(() => {
        if (step !== 'quiz') return;
    ...
    const Landing = () => (
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="glass-card text-center">
            ...
            <form onSubmit={startQuiz} style={{ maxWidth: '400px', margin: '0 auto' }}>
                <input
                    type="text"
            ...
            <div style={{ marginTop: '2rem', display: 'flex', gap: '1rem', justifyContent: 'center' }}>
                <span className="stat-pill"><Shield size={14} inline /> Proctored Session</span>
                <span className="stat-pill"><Clock size={14} inline /> 40 Questions</span>
            </div>
            ...
            <div className="container">
                <motion.div initial={{ scale: 0.9, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} className="glass-card text-center">
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem', marginBottom: '2.5rem' }}>
                        ...
                        <div style={{ background: 'rgba(255,255,255,0.03)', padding: '1.5rem', borderRadius: '16px', border: '1px solid var(--border)' }}>
                            <h3 style={{ fontSize: '2rem', color: 'var(--accent)' }}>{percentage}%</h3>
    ...
    const Review = () => (
        <div className="container" style={{ paddingBottom: '5rem' }}>
            <h2 style={{ marginBottom: '2rem', display: 'flex', alignItems: 'center', gap: '1rem' }}>
                Review Solutions <button className="stat-pill" onClick={() => setStep('result')}>Back to Summary</button>
            </h2>
            {questions.map((q, idx) => (
    ...
    const AdminView = () => (
        <div className="container">
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '2rem' }}>
                ...
                <button className="btn" onClick={() => setStep('landing')}><ChevronLeft /> Back</button>
            </div>
